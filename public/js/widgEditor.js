...
var widgStylesheet = "/css/widgeditor/widgContent.css";
	...
	for (var i = 0; i < widgToolbarItems.length; i++)
	{
		switch (widgToolbarItems[i])
		{
			...
			case "htmlsource":
				...
				break;
			case "blockformat":
				this.addSelect(this.theList.id + "SelectBlock", "widgSelectBlock adjustSelectBlock", widgSelectBlockOptions, "formatblock");
